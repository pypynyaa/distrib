...
function Finance({payouts,onPayoutRequest,currentUser}){
 ...
 const [error,setError]=useState('');
 const history=[['Май 2026','Все площадки','Начислено','₽ 32 840'],['Апрель 2026','Все площадки','Выплачено','₽ 28 190'],['Март 2026','Все площадки','Выплачено','₽ 25 390']];
...
function App(){
 ...
 const fixRelease=release=>{setPage('Загрузить релиз');pushToast('Исправление релиза',`Загрузите исправленные файлы и данные для «${release.title}». Старый черновик останется в истории.`)};
 const baseSearch=[
