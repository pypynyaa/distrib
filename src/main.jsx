...
function AdminDashboard({releases,users,payouts,admins,promoRequests,onModerate,onUpdateRelease,onBlockUser,onPayPayout,onAddFinance,onAddAdmin,onRemoveAdmin,onUpdatePromoStatus,section='Админка'}){
...
function App(){
 ...
 let content=currentUser.role!=='artist'
   ? page==='Поддержка'?<Support currentUser={currentUser}/>:page==='Новости'?<News isStaff items={news} onCreateNews={createNews} onDeleteNews={deleteNews}/>:<AdminDashboard section={page} releases={releases} users={users} payouts={payouts} admins={admins} promoRequests={promoRequests} onModerate={moderateRelease} onUpdateRelease={updateRelease} onBlockUser={blockUser} onPayPayout={payPayout} onAddFinance={addFinance} onAddAdmin={addAdmin} onRemoveAdmin={removeAdmin} onUpdatePromoStatus={updatePromoStatus}/>
